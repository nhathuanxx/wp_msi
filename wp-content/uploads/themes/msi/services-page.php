    ...
    <div class="page-breadcrumb bg-f9">
        <div class="container">
            <ul class="margin-0 padding-0">
                ...
                <li>
                    <span>Khám sàng lọc ung thư cổ tử cung</span>
                </li>
            </ul>
        </div>
    </div>
    <div class="service-intro bg-f9">
        <div class="container">
            <div class="service-intro__wrap">
                ...
                <h1
                    class="page-title service-intro__title font-size-30 font-weight-bold five-color-txt text-center text-uppercase">
        ...
        <div class="container">
            <div class="service-step__wrap">
                <div class="home__title home__title--light service-step__title display-flex only-mobile">
                    <h2><?php echo get_field('heading_center'); ?></h2>
                </div>
                <div class="row">
                        ...
                        <div class="service-step__list service-step__list--left">
                            ...
                            <div class="item">
                                ...
                                <div class="item__content">
                                    <h4 class="item__title font-size-18 font-weight-bold">
            ...
            <div class="testimonial">
                ...
                <div class="testimonial__data">
                    ...
                    <div class="sun-slider sun-slider--center"
                        data-slick='{"slidesToShow": 3, "nextArrow": ".testimonial__next", "prevArrow": ".testimonial__prev", "centerMode": true, "centerPadding": "0px", "dots": true, "autoplay": true, "autoplaySpeed": 8000, "responsive": [{"breakpoint": 575, "settings": {"centerMode": false, "slidesToShow": 1 } } ]}'>
